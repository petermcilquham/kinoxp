...
CREATE TABLE `emp_work` (
  ...
  PRIMARY KEY (`emp_id`,`work_id`),
  KEY `2_idx` (`work_id`),
  CONSTRAINT `1` FOREIGN KEY (`emp_id`) REFERENCES `employees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `2` FOREIGN KEY (`work_id`) REFERENCES `work_shifts` (`shift_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `emp_work` VALUES (1,1),(2,2),(3,3),(4,4),(3,5);
